...
const { getChannelVideos, getChannelVideoUrls } = require('../controllers/channelController');
...
// Novas rotas para canais
router.post('/api/channel/videos', getChannelVideos);
router.post('/api/channel/urls', getChannelVideoUrls);
